...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   getCoordinates: () => (/* binding */ getCoordinates)\n/* harmony export */ });\n// export const loadCoordinates = async () => {\r\n//   try {\r\n//     return await getCoordinates();\r\n//   } catch (error) {\r\n//     console.error(error);\r\n//   }\r\n// };\r\n\r\nconst getCoordinates = async (cityName) => {\r\n  try {\r\n    const apiKey = '6641147a6941c108105286chb9cd59b';\r\n    const response = await fetch(\r\n      `https://geocode.maps.co/search?q=${cityName}&api_key=${apiKey}`,\r\n    );\r\n    const data = await response.json();\r\n\r\n    return { lat: data[0].lat, lon: data[0].lon };\r\n  } catch (error) {\r\n    throw new Error('Hiba történt a koordináták lekérése során:', error);\r\n  }\r\n};\r\n\n\n//# sourceURL=webpack://first-project/./coordinates.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   initForm: () => (/* binding */ initForm)\n/* harmony export */ });\n/* harmony import */ var _card__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./card */ \"./card.js\");\n/* harmony import */ var _weather_network__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./weather-network */ \"./weather-network.js\");\n\r\n\r\n\r\nconst initForm = () => {\r\n  const formEl = document.getElementById('weather-form');\r\n  const cityEl = document.getElementById('city-input');\r\n  const dateEl = document.getElementById('date-input');\r\n  const submitEl = document.getElementById('submit-btn');\r\n  const weatherContainer = document.getElementById('weather-container');\r\n\r\n  formEl.addEventListener('submit', async (e) => {\r\n    e.preventDefault();\r\n\r\n    const city = cityEl.value;\r\n    const date = dateEl.value;\r\n\r\n    try {\r\n      weatherContainer.insertAdjacentHTML(\r\n        'afterbegin',\r\n        '<span id=\"loading-indicator\">Loading...</span>',\r\n      );\r\n      submitEl.disabled = true;\r\n      const weatherData = await (0,_weather_network__WEBPACK_IMPORTED_MODULE_1__.loadWeatherData)(city, date);\r\n      (0,_card__WEBPACK_IMPORTED_MODULE_0__.addCard)(city, date, weatherData);\r\n      formEl.reset();\r\n    } catch (error) {\r\n      console.error(error);\r\n    } finally {\r\n      submitEl.disabled = false;\r\n      weatherContainer.removeChild(\r\n        document.getElementById('loading-indicator'),\r\n      );\r\n    }\r\n  });\r\n};\r\n\n\n//# sourceURL=webpack://first-project/./form.js?");
